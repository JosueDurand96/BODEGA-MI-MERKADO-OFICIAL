package com.mimerkado.networking.credential
...
object SecureOkHttpClient {
    ...
    fun getSecureOkHttpClient(
        ...
        try {
            SecureOkHttpClient.pwd = pwd
            SecureOkHttpClient.certificate = certificate
            SecureOkHttpClient.instanceType = instanceType
            SecureOkHttpClient.keyAlgorithm = keyAlgorithm
