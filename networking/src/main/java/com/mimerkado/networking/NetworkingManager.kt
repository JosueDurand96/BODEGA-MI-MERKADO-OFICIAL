package com.mimerkado.networking

import com.mimerkado.networking.interactor.coroutine.NetworkingCoroutineBuilder
import com.mimerkado.networking.interactor.rx.NetworkingRxBuilder
...
object NetworkingManager {
    ...
    private fun getOkHttpClient(
        ...
        if (bcpNetworkingConfiguration.mutual!!) {
            val pwd = bcpNetworking?.pwd
            val certificate = bcpNetworking?.certificate
    ...
    fun init(bcpNetworking: Networking) {
        NetworkingManager.bcpNetworking = bcpNetworking
    }
}