...
import com.mimerkado.networking.interactor.coroutine.formurlencoded.CoroutineFormUrlEncodedPayload
import com.mimerkado.networking.interactor.coroutine.json.CoroutineJsonPayload
    ...
    GET {
        ...
        override suspend fun execute(bcpNetworkingConfiguration: NetworkingConfiguration): ResultService {
            return NetworkingCoroutineService.execute(
                payloadCoroutineType(bcpNetworkingConfiguration.bodyType!!).payload(
